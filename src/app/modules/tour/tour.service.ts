...
import { QueryBuilder } from "../../utils/QuesryBuilder";
...
const getAllTours = async (query: Record<string, string>) => {
    ...
    // const allTours = await  tours.find(filter).sort(sort).select(fields).limit(limit).skip(skip)
